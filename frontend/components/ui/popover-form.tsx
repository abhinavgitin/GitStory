        ...
        {open && (
          ...
          >
            <motion.span
              ...
              layoutId={shouldReduceMotion ? undefined : `${title}-title`}
            ...
            {showCloseButton && (
              <div className="absolute -top-[5px] left-1/2 transform -translate-x-1/2 w-[16px] h-[26px] flex items-center justify-center z-20">
                <button
                  onClick={() => setOpen(false)}
                  className="absolute z-10 -mt-1 flex items-center justify-center w-6 h-6 text-muted-foreground hover:text-foreground focus:outline-none rounded-full cursor-pointer"
                  aria-label="Close"
                >
                  <ChevronUp className="w-3.5 h-3.5 text-muted-foreground/80 hover:text-white transition-colors" />
                </button>
...
export function PopoverFormSeparator({
  ...
  return (
    ...
    >
      <path d="M0 1H480" className="stroke-border" strokeDasharray="4 4" />
    </svg>
  )
}
